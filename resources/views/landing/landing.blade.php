...
De modo que, la investigación se encamina a cerrar la brecha entre las actividades económicas de las comunidades y la conservación del entorno, ya que ésta zona es de importancia estratégica nacional. Conforme a lo anterior, la conveniencia del proyecto radica en cuanto a la posibilidad de determinar si una comunidad pudiera permanecer en zonas de protección y conexas a partir de la generación de actividades en pro de la sostenibilidad del territorio.
	                ...
	                <div class="col-sm-5 great-support-box wow fadeInUp">
	                    <img src="assets/img/devices/2.jpg" alt="">
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 features section-description wow fadeIn">
	                     <h2><strong>Nuestros</strong> Objetivos</h2>
	                    <div class="divider-1 wow fadeInUp"><span></span></div>
	                </div>
	            </div>
	            <div class="row">
                	<div class="col-sm-4 features-box wow fadeInUp">
	                   ...
	                   <h3>Diagnosticar</h3>
	                    <p>los terrenos ubicados en áreas de protección especial en el municipio de San Juanito – Meta.</p>
                    </div>
                    <div class="col-sm-4 features-box wow fadeInDown">
	                   ...
	                   <h3>Caracterizar</h3>
	                    <p>las explotaciones económicas y/o de subsistencia desarrolladas en los terrenos ubicados en áreas de protección especial. </p>
                    </div>
                    <div class="col-sm-4 features-box wow fadeInUp">
	                	<div class="features-box-icon">
	                		<i class="fa fa-cog"></i>
	                	</div>
	   <h3>Determinar sostenibilidad</h3>
	                    <p>Económica, Social y Ambiental de las explotaciones desarrolladas en terrenos  ubicados en áreas de protección especial en el municipio de San Juanito- Meta.</p>
                    </div>
	            </div>
	            <div class="row">
	            	<div class="col-sm-12 section-bottom-button wow fadeInUp">
                        <a class="btn btn-link-1 scroll-link" href="#more-features">Leer Mas</a>
	            	</div>
	            </div>
	        </div>
        </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 more-features section-description wow fadeIn">
	                    <h2><strong>Desarrollo</strong> Sostenible</h2>
	                    <div class="divider-1 wow fadeInUp"><span></span></div>
	                </div>
	            </div>
	            <div class="row">
	                ...
	                <div class="col-sm-7 more-features-box wow fadeInUp">
	                    ...
	                    <div class="more-features-box-text">
	                    	...
	                    	<div class="more-features-box-text-description">
	                    		Puede entenderse la dimensión social como lo relacionado a la socialización de un individuo. Los seres humanos son seres sociales: satisfacen sus necesidades materiales y simbólicas en grupo. 
	                    	</div>
	                    </div>
	                    <div class="more-features-box-text">
	                    	<div class="more-features-box-text-icon">
	                    	...
	                    	<h3>Dimensión Politico-Institucional</h3>
	                    	<div class="more-features-box-text-description">
	                    		La sociología del conflicto contempla una “élite de poder” compuesta principalmente por los líderes de las corporaciones, que ostentan casi todo el poder, a menudo de forma encubierta.
	                    	</div>
	                    </div>
