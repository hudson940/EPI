...
<div class="card">
        ...
        <div class="card-body">
             <iframe src="http://docs.google.com/gview?url={{asset('storage/instrumento.pdf')}}&embedded=true" style="width:100%; height:800px;" frameborder="0"></iframe>        
...
<div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Lista de terminos</h3>
                    </div>
        <div class="card-body">
             <iframe src="http://docs.google.com/gview?url={{asset('storage/lista-terminos.pdf')}}&embedded=true" style="width:100%; height:800px;" frameborder="0"></iframe>        
