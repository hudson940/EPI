...
Route::put('formularioc/{formulario}','FormularioC@update' )->name('formularioc.update');
Route::get('formularioc/{formulario}/edit','FormularioC@edit' )->name('formularioc.edit');
Route::put('formulariof/{formulario}','FormularioF@update' )->name('formulariof.update');
Route::get('formulariof/{formulario}/edit','FormularioF@edit' )->name('formulariof.edit');
